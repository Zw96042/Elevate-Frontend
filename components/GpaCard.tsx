  ...
  <View className="bg-cardColor rounded-xl px-3 py-2 w-[48%]">
    ...
    <View className="flex-row justify-between">
      <View className="items-start">
        ...
        <Text className="text-main text-sm font-bold">{data.unweighted.toFixed(2)}</Text>
      </View>
      <View className="items-end">
        <Text className="text-secondary text-xs">Weighted</Text>
        <Text className="text-main text-sm font-bold">{data.weighted.toFixed(2)}</Text>
      </View>
    </View>
  </View>
);
  ...
  <View className="bg-cardColor rounded-xl px-4 py-3 flex-row items-center justify-between mb-5">
    ...
    <View className="flex-row items-center space-x-6">
      <View className="items-center">
        ...
        <Text className="text-main text-lg font-bold">{data.unweighted.toFixed(2)}</Text>
      </View>
      <View className="items-center">
        <Text className="text-secondary text-xs">Weighted</Text>
        <Text className="text-main text-lg font-bold">{data.weighted.toFixed(2)}</Text>
      </View>
    </View>
  </View>
);